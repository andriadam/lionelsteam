...
if ($_SESSION['hak_akses'] == 'admin') { ?>
	...
	<ul class="sidebar-menu">
		...
		// jika menu galeri dipilih, menu galeri aktif
		if ($_GET["module"] == "galeri" || $_GET["module"] == "form_galeri") { ?>
			<li class="active">
				<a href="?module=galeri"><i class="fa fa-file-image-o"></i> Galeri </a>
			</li>
		<?php
		}
		// jika tidak, menu galeri tidak aktif
		else { ?>
			<li>
				<a href="?module=galeri"><i class="fa fa-file-image-o"></i> Galeri </a>
			</li>
		...
		if ($_GET["module"] == "laporan") { ?>
			<li class="active">
				<a href="?module=laporan"><i class="fa fa-file"></i> Laporan</a>
			</li>
		<?php
		}
