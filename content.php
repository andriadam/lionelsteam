...
// jika user sudah login, maka jalankan perintah untuk pemanggilan file halaman konten
	...
	// jika halaman konten yang dipilih galeri, panggil file view galeri
	elseif ($_GET['module'] == 'galeri') {
		include "modules/galeri/view.php";
	}

	// jika halaman konten yang dipilih form galeri, panggil file form galeri
	elseif ($_GET['module'] == 'form_galeri') {
