...
<head>
  <meta charset="UTF-8">
  <title>Admin Panel | Steam Mobil dan Motor</title>
...
<body class="skin-red fixed">
  <div class="wrapper">
    ...
    <header class="main-header">
      <!-- Logo -->
      <a href="index2.html" class="logo"><b>Lionel</b>Steam</a>
        ...
        <div class="row">
          <div class="col-12">
            <ul class="social-icons text-center">
              ...
              <li><a class="dribbble" href="#"><i class="fa fa-twitter-square"></i></a></li>
            </ul>
          </div>
        </div>
        <hr>
    ...
    <!-- <footer class="main-footer">
      <strong>Copyright &copy; 2021 - Lionel Steam</a>.</strong>
    </footer> -->
  </div><!-- ./wrapper -->
