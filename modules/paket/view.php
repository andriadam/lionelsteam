          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            <thead>
              <tr>
                ...
                <th class="center">Foto Paket</th>
                <th class="center">Ket. Paket</th>
                <th></th>
              </tr>
            </thead>
            <!-- tampilan tabel body -->
            <tbody>
              ...
              $query = mysqli_query($mysqli, "SELECT * FROM paket ORDER BY id_paket DESC")
              ...
              while ($data = mysqli_fetch_assoc($query)) {
                ...
                echo "<tr>
                      ...
                      <td width='120'>$data[jenis_kendaraan]</td>
                      <td width='80' align='right'>Rp. " . format_rupiah($data['harga']) . "</td>
                      <td width='100'><img src='assets/img/paket/$data[foto_paket]'class='mr-3 bg-light'></td>
                      <td width='200'>$data[ket_paket]</td>
