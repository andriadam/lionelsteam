...
<body>
  ...
  <div class="jumbotron jumbotron-fluid text-center mb-0" style="height: 350px;">
    <div class="container" style="padding-top:70px">
      <h1 class="display-6">Paket</h1>
      <hr>
    </div>
  </div>

  <!-- Galeri -->
  <section class="paket my-4">
    <div class="container">

      <div class="row">
        <?php
        // fungsi query untuk menampilkan data dari tabel paket
        $query = mysqli_query($mysqli, "SELECT * FROM paket")
          or die('Ada kesalahan pada query tampil data paket: ' . mysqli_error($mysqli));
        while ($data = mysqli_fetch_assoc($query)) :   ?>
          <div class="col-sm-6 <?= ($data['nama_paket'] == 'Paket Mobil Besar') ? 'offset-sm-3' : '' ?>">
            <div class="card mb-3" style="max-width: 540px;">
              <div class="row no-gutters">
                <div class="col-md-4">
                  <img src="assets/img/paket/<?= $data['foto_paket'] ?>" class="img-fluid" alt="...">
                </div>
                <div class="col-md-8">
                  <div class="card-body">
